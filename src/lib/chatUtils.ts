...
export function getDisplayTitle(chat: Chat | null | undefined, t: (key: TranslationKey) => string): string {
  ...
  // Handle simple Roleplay/Topic/Dictionary default titles if they exactly match the English default
  ...
  if (chat.title === 'Dictionary Practice') return t('chat.defaultTitle.dictionary');
